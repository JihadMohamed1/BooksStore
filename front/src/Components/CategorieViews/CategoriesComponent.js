...
export default function Categories () {
    ...
    return (
      ...
      <Card.Body>
       <Button variant="danger" onClick={()=>DeleteCatigories(cat._id)}>Delete</Button>
        <Button variant="success" href={`/Admin/EditCatigories/${cat._id}`} >Modifier</Button>
        <Button variant="primary" href={`/Admin/CategorieBook/${cat._id}`} >Details</Button>
      </Card.Body>
    </Card>
            </li>)   
